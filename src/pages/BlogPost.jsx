        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-6 mb-8">
              <span className="inline-flex items-center gap-2 text-xs text-[var(--aegis-rust)] uppercase tracking-widest border-l-2 border-[var(--aegis-rust)] pl-2">
                {post.category}
              </span>
            ...
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-medium text-[var(--aegis-text-primary)] mb-8 leading-tight">
              {post.title}
            </h1>

            <p className="text-xl text-[var(--aegis-text-secondary)] leading-relaxed mb-16 border-l-2 border-[var(--aegis-sage)] pl-6">
              {post.excerpt}
            </p>
          </motion.div>
          ...
          <div className="space-y-16">
            {content?.sections.map((section, index) => (
              ...
              >
                <h2 className="font-display text-2xl font-medium text-[var(--aegis-text-primary)] mb-6">
                  {section.heading}
                </h2>
                  ...
                  {section.content.split('\n\n').map((paragraph, pIndex) => (
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: paragraph
                          .replace(/\*\*(.*?)\*\*/g, '<strong class="text-[var(--aegis-text-primary)] font-medium">$1</strong>')
                      }}
                    />
                  ))}
                </div>
          ...
          >
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
              <div>
                ...
                <p className="text-[var(--aegis-text-primary)] font-display text-lg">AEGIS AI Cooperative</p>
              </div>
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-[var(--aegis-text-primary)] text-[var(--aegis-void)] px-6 py-3 text-sm uppercase tracking-widest font-semibold hover:bg-[var(--aegis-rust)] transition-colors"
              >
                Discuss This Topic
              </Link>
            </div>
